...
class _MyHomePageState extends State<MyHomePage> {
  ...
  // Method to fetch the images and store in _fetchedImages
  Future<void> _fetchImages() async {
    try {
      ApiService apiService = ApiService();
      List<Uint8List> images = await apiService.postFaceManipulation(
      ...
      setState(() {
        _fetchedImages = images.take(5).toList(); // Take the first 5 images
